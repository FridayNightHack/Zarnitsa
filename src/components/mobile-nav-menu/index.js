...
MobileNavMenu.Wrapper = function MobileNavMenuWrapper({ children, ...restProps }) {
...
MobileNavMenu.AttributionLink = function MobileNavMenuAttributionLink({ children, ...restProps }) {
  return <AttributionLink {...restProps}>{children}</AttributionLink>;
};

MobileNavMenu.Button = function MobileNavMenuButton({ children, ...restProps }) {
